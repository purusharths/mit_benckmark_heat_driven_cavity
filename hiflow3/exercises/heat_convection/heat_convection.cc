...
static const char *PARAM_FILENAME = "heat_convection.xml";
...
void FoilNavierStokes::prepare_system() 
{
  ...
  const int nb_fe_var = 3; // 2->3 for temperature variable.
  ...
  fe_ansatz[0] = FE_TYPE_LAGRANGE_VECTOR;
  fe_ansatz[1] = FE_TYPE_LAGRANGE;
  fe_ansatz[2] = FE_TYPE_LAGRANGE; // theta
...
{     
  ...
  name << "heat_convection" << "_" << time_step;
